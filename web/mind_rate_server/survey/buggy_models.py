...
class Study(models.Model):
	study_director_id = models.ForeignKey("Study Director", StudyDirector)
...
class Questionnaire(models.Model):
	study_director_id = models.ForeignKey("Study Director", StudyDirector)
	study_id = models.ForeignKey("Study", Study)
...
class TriggerEvent(models.Model):
	...
	questionnaire_id = models.ForeignKey("Belongs to Questionnaire No.", Questionnaire)
...
class CommonQuestion(models.Model):
	study_director_id = models.ForeignKey("Study Director ID", StudyDirector)
	study_id = models.ForeignKey("Study ID", Study)
	questionnaire_id = models.ForeignKey("Questionnaire ID", Questionnaire)
...
class Answer(models.Model):
	...
	study_id = models.ForeignKey("Study ID", Study)
	questionnaire_id = models.ForeignKey("Questionnaire ID", Questionnaire)
	question_id = models.ForeignKey("Question", Question)
	proband_id = models.ForeignKey("Proband", Proband)
...
class NotAnsweredQuestionnaire(models.Model):
	...
	proband_id = models.ForeignKey("Belongs to Proband No.", Proband)
	questionnaire_id = models.ForeignKey("Questionnaire ID", Questionnaire)
